...
#  DROOP  : Heaviside (segment masks from unit steps, no integer variables)
#
...
const METHOD         = "Heaviside"
const FIGSUF         = "_iva_heaviside"
...
if INTERACTIVE
    ...
    println("IEEE 1547 Volt-VAr control encoded using the Heaviside formulation.")
...
if INTERACTIVE
    ...
    println("  2. solve the resulting nonlinear optimization problem,")
...
for it in 1:MAX_ITER
    ...
    #  NLP solver has to cope with, on top of the outer linearisation loop.
