...
if INTERACTIVE
    ...
    println("Volt-VAr control encoded using the Heaviside formulation.")
...
if INTERACTIVE
    ...
    println("  3. embed the IEEE 1547 Volt-VAr curve using the Heaviside formulation, and")
